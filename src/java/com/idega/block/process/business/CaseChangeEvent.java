 ...
 */
public class CaseChangeEvent extends ApplicationEvent {

	private static final long serialVersionUID = -911413110096385992L;
	...
	public String toString() {
		return "Status from " + getStatusFrom() + " to " + getStatusTo() + " for case " + getCase() + " by " + getPerformer() + " at " + getTimestamp() + ". Attributes: " + getAttributes();
	}
