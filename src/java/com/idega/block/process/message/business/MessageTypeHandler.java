/*
 * $Id: MessageTypeHandler.java,v 1.1 2005/10/19 12:52:55 laddi Exp $
...
public class MessageTypeHandler implements ICPropertyHandler {
	...
	public PresentationObject getHandlerObject(String name, String stringValue, IWContext iwc) {
		...
		Iterator iter = MessageTypeManager.getInstance().getMessageCodes().iterator();
		while (iter.hasNext()) {
			String code = (String) iter.next();
			try {
				CaseCode caseCode = getCaseBusiness(iwc).getCaseCode(code);
