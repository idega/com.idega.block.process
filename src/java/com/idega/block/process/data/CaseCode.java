...
public interface CaseCode extends com.idega.data.IDOEntity
{
 ...
 public com.idega.core.data.ICObject getBusinessHandler() throws java.rmi.RemoteException;
 public java.lang.Class getPrimaryKeyClass() throws java.rmi.RemoteException;
 public void setBusinessHandler(com.idega.core.data.ICObject p0) throws java.rmi.RemoteException;
