...
function getLocalizationForCases() {
	CasesEngine.getInfoForCases(getLocalizationForCasesCallback);
}
...
function reloadCasesByNewType(caseType) {
	...
	CasesEngine.getCasesList(caseType, {
...
function setCaseForPreview(caseId) {
	showLoadingMessage(LOADING_TEXT);
	CasesEngine.getCaseOverview(caseId, getCaseOverviewCallback);
}
